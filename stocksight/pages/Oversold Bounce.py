...
st.set_page_config(page_title="Oversold Bounce | StockSight", page_icon="📉", layout="wide")
inject_css()
...
with st.sidebar:
    ...
    PE: 5 – 50<br>
    Volume: ≥ 2× avg<br>
    RSI: 30 – 40 (rising)<br><br>
    <b>Signal</b><br>
    BUY on green reversal candle<br><br>
    <b>Timeframe</b><br>
    Swing · 3–21 days
    </div>
    ...
    rsi_range = st.slider("RSI Range (14)", 30, 80, (30, 40), 1)
...
if run:
    ...
    st.session_state["ob_universe"] = universe

results = st.session_state.get("ob_results", None)

if results is None:
    st.info("👆 Select your universe and click **SCAN NOW** to find oversold bounce candidates.")
elif not results:
