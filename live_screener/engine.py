...
def signal_result_to_row(r: SignalResult, cfg: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "state": getattr(r, "bottom_state", None),
        "score": getattr(r, "bottom_score", None),
        "groups_hit": getattr(r, "bottom_groups_hit", None),
        "invalidation": getattr(r, "invalidation", None),
        "stop_pct": getattr(r, "stop_pct_layer3", None),
        "position_size": getattr(r, "position_size", None),
